...
const Item = ({ imgUserPerfil, firstname, lastname, buttonActive }) => {
    const [ isOpen, setIsOpen ] = useState(false);
    return (
        <div className='user'>
            <div className='user__info'>
                <div className='img-user'>
                    {imgUserPerfil ? <ImgUser img={imgUserPerfil} /> : <IconNotImg />}
                </div>
            ...
            <ButtonOptionsMovil isOpen={isOpen} setIsOpen={setIsOpen} />
        </div>
    );
}
